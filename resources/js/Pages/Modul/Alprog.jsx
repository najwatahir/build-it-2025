                        ...
                        <div className="flex flex-col justify-between mt-20 mb-20 md:mb-36">
                            <div className="flex flex-col z-20 items-center">
                                ...
                                >
                                    ...
                                    fondasi penting dalam pendidikan ilmu
                                    komputer yang berfokus pada pengenalan
                                    konsep dasar algoritma dan teknik
                                    pemrograman. Mahasiswa akan mempelajari
                                    bagaimana merancang, menganalisis, dan
                                    mengimplementasikan algoritma untuk
                                    memecahkan berbagai masalah komputasi. Mata
                                    kuliah ini mencakup topik-topik seperti
                                    struktur data, pengendalian alur program,
                                    pemrosesan data, dan teknik pemecahan
                                    masalah.
                                </p>
                                <a
                    ...
                    <div className="px-6 md:px-24 mb-36">
                        <div className="flex flex-col justify-center items-center z-10">
                            ...
                            >
                                ...
                                Pemrograman pada BUILD IT 2025 merupakan
                                ex-asisten dosen pada praktikum Algoritma dan
                                Pemrogaman.
                            </p>
                        </div>
                        <div className="flex flex-col md:flex-row justify-center gap-28 md:gap-x-4 items-center mt-36">
                            <CardPembicara
                                imageSrc="../../../asset/images/modul/AryaFlip.png"
