...
export default function JaringanKomputer() {
    ...
    text-balance"
                                ...
                                >
                                    ...
                                    merupakan salah satu mata kuliah penting
                                    dalam bidang teknologi informasi yang
                                    membahas prinsip-prinsip dasar, arsitektur,
                                    dan teknologi yang digunakan dalam jaringan
                                    komputer serta komunikasi data. Mahasiswa
                                    akan mempelajari berbagai topik seperti
                                    model OSI (Open Systems Interconnection),
                                    protokol jaringan, pengalamatan IP,
                                    subnetting, routing, switching, dan keamanan
                                    jaringan.
                                </p>
                                <a
                    ...
                    <div className="px-6 md:px-24 mb-36">
                        <div className="flex flex-col justify-center items-center z-10">
                            ...
                            >
                                ...
                                Komputer dan Komunikasi pada BUILD IT 2025
                                merupakan ex-asisten dosen pada praktikum
                                Jaringan Komputer dan Komunikasi.
                            </p>
                        </div>
