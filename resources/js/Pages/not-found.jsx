...
export default function Custom404() {
    return (
        ...
        <Head title="Not Found" />
            <div className="bg-white min-h-screen flex flex-col gap-12 justify-center items-center px-4">
                <h1 className="text-center font-[Varsity] uppercase tracking-[0.1em] leading-[0.87em] text-[clamp(72px,20vw,288px)] bg-gradient-to-r from-[#201349] to-[#513E99] bg-clip-text text-transparent">
                    404
                </h1>
                <div className="flex flex-col gap-8 justify-center items-center">
                    <h1 className="text-center font-montserrat uppercase text-[clamp(32px,6vw,64px)] font-bold leading-normal bg-gradient-to-r from-[#201349] to-[#513E99] bg-clip-text text-transparent">
                        Tidak Ditemukan
                    </h1>
